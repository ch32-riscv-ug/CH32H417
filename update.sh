...
curl -z CH32H417DS0.PDF -o CH32H417DS0.PDF https://file.wch.cn/download/file?id=529
# https://www.wch.cn/downloads/CH32H417RM_PDF.html
curl -z CH32H417RM.PDF -o CH32H417RM.PDF https://file.wch.cn/download/file?id=532
cd ..

# https://www.wch.cn/downloads/CH32H417EVT_ZIP.html
curl -z CH32H417EVT.ZIP -o CH32H417EVT.ZIP https://file.wch.cn/download/file?id=530
rm -rfv EVT
unzip -O GB2312 *.ZIP
