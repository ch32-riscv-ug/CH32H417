...
/* RGB565 pixel 480*272 */
#define OV5640_RGB565_WIDTH  480
#define OV5640_RGB565_HEIGHT 272

#define OV5640_SCCB_ID  0x3C
...
/* PC14-RESET  PD3-PWDN */
#define OV_RESET_SET    {GPIOC->BSHR = GPIO_Pin_14;}
#define OV_RESET_CLR    {GPIOC->BCR = GPIO_Pin_14;}
#define OV_PWDN_SET     {GPIOD->BSHR = GPIO_Pin_3;}
#define OV_PWDN_CLR     {GPIOD->BCR = GPIO_Pin_3;}

/* PC4-SCL  PA1-SDA */
#define IIC_SCL_IN      {GPIOC->CFGLR&=0XFFF0FFFF;GPIOC->CFGLR|=8<<16;}
#define IIC_SCL_OUT     {GPIOC->CFGLR&=0XFFF0FFFF;GPIOC->CFGLR|=3<<16;}
#define IIC_SDA_IN      {GPIOA->CFGLR&=0XFFFFFF0F;GPIOA->CFGLR|=8<<4;}
#define IIC_SDA_OUT     {GPIOA->CFGLR&=0XFFFFFF0F;GPIOA->CFGLR|=3<<4;}


#define IIC_SCL_SET     {GPIOC->BSHR = GPIO_Pin_4;}
#define IIC_SCL_CLR     {GPIOC->BCR = GPIO_Pin_4;}
#define IIC_SDA_SET     {GPIOA->BSHR = GPIO_Pin_1;}
#define IIC_SDA_CLR     {GPIOA->BCR = GPIO_Pin_1;}

#define SDA_IN_R        (GPIOA->INDR & GPIO_Pin_1)
