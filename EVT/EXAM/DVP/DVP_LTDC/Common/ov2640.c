...
UINT8 OV2640_SCCB_WR_Reg(UINT8 Reg_Adr,UINT8 Reg_Val)
{
	...
	OV2640_SCCB_Start();
	if(OV2640_SCCB_WR_Byte(OV2640_SCCB_ID))res=1;
	Delay_Us(100);
...
UINT8 OV2640_SCCB_RD_Reg(UINT8 Reg_Adr)
{
	...
	OV2640_SCCB_Start();
	OV2640_SCCB_WR_Byte(OV2640_SCCB_ID);
	Delay_Us(100);
	...
	OV2640_SCCB_Start();
	OV2640_SCCB_WR_Byte(OV2640_SCCB_ID|0X01);
	Delay_Us(100);
...
void OV2640_DVP_GPIO_Init(void) 
{
    ...
    RCC_HB2PeriphClockCmd(RCC_HB2Periph_AFIO | RCC_HB2Periph_GPIOA | RCC_HB2Periph_GPIOE | RCC_HB2Periph_GPIOB | 
                          RCC_HB2Periph_GPIOC | RCC_HB2Periph_GPIOD | RCC_HB2Periph_GPIOF, ENABLE);

	/* DPWDN-PD3  RESET-PC14 */
    ...
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource4, GPIO_AF13);   /* HERF */ 
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
