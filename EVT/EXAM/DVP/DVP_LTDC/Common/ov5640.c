...
UINT8 OV5640_SCCB_Write_Reg(UINT16 Reg_Adr,UINT8 Reg_Val)
{
	...
	OV5640_SCCB_Start();
	if(OV5640_SCCB_Write_Byte((OV5640_SCCB_ID << 1) | SCCB_WRITE)) t=1;
...
UINT8 OV5640_SCCB_Read_Reg(UINT16 Reg_Adr)
{
	...
	OV5640_SCCB_Start();
	OV5640_SCCB_Write_Byte((OV5640_SCCB_ID << 1) | SCCB_WRITE);
    OV5640_SCCB_Write_Byte((Reg_Adr >> 8) & 0xFF);
    OV5640_SCCB_Write_Byte(Reg_Adr & 0xFF);
	OV5640_SCCB_Stop();

	OV5640_SCCB_Start();
	OV5640_SCCB_Write_Byte((OV5640_SCCB_ID << 1) | SCCB_READ);
