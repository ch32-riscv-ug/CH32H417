...
void DVP_GPIO_Init(void)
{
    ...
    RCC_HB2PeriphClockCmd(RCC_HB2Periph_AFIO | RCC_HB2Periph_GPIOE | RCC_HB2Periph_GPIOB | RCC_HB2Periph_GPIOC | RCC_HB2Periph_GPIOD, ENABLE); 
	...
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource6, GPIO_AF13);  //D5
...
UINT8 OV2640_OutSize_Set(UINT16 Image_width,UINT16 Image_height)
{
	...
	Out_Size_Width=Image_width/4;  //60
	Out_Size_Height=Image_height/4;  //80
