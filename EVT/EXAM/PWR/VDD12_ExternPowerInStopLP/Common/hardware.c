...
void Hardware(void)
{
    ...
    Delay_Ms(10);
        ...
        /* The frequency needs to be reduced before enter stop lowpower */
        HSIAsSystemSource();
        /* GPIO high level (3.3V) corresponds to the stop mode (the regulator enters low-power mode) 
        Adjust the DC-DC output voltage to reduce current consumption. */
    ...
    {
        /* After the system wakes up, the DC-DC output voltage is adjusted first. */
