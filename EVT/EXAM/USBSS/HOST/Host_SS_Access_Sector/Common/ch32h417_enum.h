...
#define ERR_USB_BUF_OVER       0x17    /* Incorrect USB transfer data or buffer overflow due to excessive data length */
#define ERR_USB_LENGTH         0x18
#define ERR_USB_DATAERR        0x19
/* The following status codes 1XH are operation status codes for USB host mode, values can be customized. Definitions below are for CH37x compatibility only. */
#define ERR_USB_UNKNOWN                      0xFA          /* Unknown error, unexpected condition, check hardware or program logic */
#ifndef USB_INT_SUCCESS
#define USB_OPERATE_SUCCESS                  0x00          /* USB operation completed successfully */
#define USB_OPERATE_ERROR                    0x01          /* USB operation failed */
#define USB_PARAMETER_ERROR                  0x03          /* Invalid parameter, value out of valid range */
#define USB_INT_CONNECT_U20                  0x13          /* USB device attach event detected */
#define USB_INT_SUCCESS                      0x14          /* USB transaction or data transfer finished successfully */
...
#define USB_INT_BUF_OVER                     0x17          /* Excessive data for USB control transfer, buffer overflow */
#define USB_INT_DISK_ERR                     0x1F          /* USB storage device operation failed */
#define USB_INT_DISK_ERR1                    0x20          /* USB storage device operation failed */
#define USB_CH417USBTIMEOUT                  0x28          /* USB device communication timeout */
#endif
#define U30_PID_OUT                       0x00          /* OUT token packet */
#define U30_PID_IN                        0x01          /* IN token packet */
...
// PID definition: 00: OUT, 01:SOF, 10:IN, 11:SETUP
#define PID_OUT     0
#define PID_SOF     1
#define PID_IN      2
//#define PID_SETUP 3
/* Connected device speed definition */
#define USB_DEV_SPEED_LS        0x01                        /* Current connected device is low?speed */
#define USB_DEV_SPEED_FS        0x00                        /* Current connected device is full?speed */
...
#define USB_BO_CBW_SIG0         0x55    /* CBW signature byte 'U' of tag 'USBC' */
#define USB_BO_CBW_SIG1         0x53
#define USB_BO_CBW_SIG2         0x42
#define USB_BO_CBW_SIG3         0x43
#define USB_BO_CSW_SIG0         0x55    /* CSW signature byte 'U' of tag 'USBS' */
...
extern volatile UINT8   gDeviceConnectstatus;                                        /* USB device connection status */
