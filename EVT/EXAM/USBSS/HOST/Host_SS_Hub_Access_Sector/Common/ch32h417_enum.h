...
#define ERR_USB_TRANSFER        0x20    /* NAK / STALL and other transfer error codes range from 0x20 ~ 0x2F */
...
#define ERR_USB_BUF_OVER        0x17    /* USB data error or payload too large, buffer overflow */
#define ERR_USB_LENGTH          0x18
#define ERR_USB_DATAERR         0x19

/* Status code 1XH defined for USB host operation, compatible with CH37x series */
#define ERR_USB_UNKNOWN         0xFA            /* Unknown error, unexpected condition, check hardware or firmware */
...
#define USB_INT_CONNECT_U20     0x13            /* USB device attach event detected */
#define USB_INT_SUCCESS         0x14            /* USB transaction or transfer completed successfully */
#define USB_INT_CONNECT         0x15            /* USB device attach event detected */
#define USB_INT_DISCONNECT      0x16            /* USB device detach event detected */
#define USB_INT_BUF_OVER        0x17            /* Control transfer payload exceeds buffer size, overflow */
...
#define USB_CH417USBTIMEOUT     0x28            /* USB device communication timeout */
#endif

#define USB_CH417USBTIMEOUTVALUE    0x3fffff

#define U30_PID_OUT             0x00            /* OUT token */
#define U30_PID_IN              0x01            /* IN token */
...
/* Bit definitions for USB request type byte */
...
#define USB_REQ_TYP_MASK        0x60        /* Request type bitmask */
#define USB_REQ_TYP_STANDARD    0x00
#define USB_REQ_TYP_CLASS       0x20
#define USB_REQ_TYP_VENDOR      0x40
#define USB_REQ_TYP_RESERVED    0x60
#define USB_REQ_RECIP_MASK      0x1F        /* Recipient bitmask */
...
/* Request type for HUB class commands */
...
/* HUB class feature selector values */
...
/* USB endpoint attributes and masks */
...
#define USB_SSDEVICE_ADDR           0x02    /* Default Super Speed USB device address */
#define USB_HSDEVICE_ADDR           0x0A    /* Default High Speed USB device address */
#endif

#ifndef DEFAULT_ENDP0_SIZE
#define DEFAULT_ENDP0_SIZE         64      /* Default max packet size for endpoint0 */
#endif

#ifndef MAX_PACKET_SIZE
#define MAX_PACKET_SIZE            512     /* Maximum USB packet size */
#endif
...
#if 0                           /* Enable only for special scenarios */
...
// #define USB_BO_CBW_SIG              0x43425355      /* CBW signature magic word 'USBC' */
// #define USB_BO_CSW_SIG              0x53425355      /* CSW signature magic word 'USBS' */
...
//     UINT8  mCBW_LUN;
//     UINT8  mCBW_CB_Len;                         /* Input: valid CB length, range 1 ~ 16 */
...
typedef struct _USB_ENDPOINT_DESCRIPTOR_U30 
{
	UINT8  bLength;
	UINT8  bDescriptorType;
	UINT8  bEndpointAddress;
...
extern UINT8   gDeviceUsbType;															/* USB connection status: 01 - USB 2.0 & 1.1; 02 - USB 3.0 */
...
extern volatile UINT8   gDeviceConnectstatus;													
...
extern UINT8 U30HostCtrlTransfer( PUINT8 ReqBuf, PUINT8 DatBuf, PUINT16 RetLen ) ; 
...
extern UINT8 udisk_vidpid_buf[ 4 ] ;   											  


extern uint8_t  gDiskMaxLun;				    										/* The maximum logical unit number of the disk */
extern uint8_t  gDiskCurLun;	    													/* The current operation logic unit number of the disk */
extern UINT32   gDiskCapability;		    											/* Total disk capacity */
extern UINT32   gDiskPerSecSize;	    												/* Disk sector size */
extern uint8_t  gDiskBulkInEp;															/* The IN endpoint address of the USB large-capacity storage device */
extern uint8_t  gDiskBulkInTog;														    /* USB high-capacity transmission synchronization logo */
extern uint8_t  gDiskBulkInBrust;														/* IN brust quantity */
extern uint8_t  gDiskBulkOutEp;														    /* The OUT endpoint address of the USB large-capacity storage device */
extern uint8_t  gDiskBulkOutTog;														/* USB high-capacity transmission synchronization logo */
extern uint8_t  gDiskBulkOutBrust;														/* OUT burst quantity */
extern uint16_t gDiskBulkInEpSize;  	    											/* The maximum packet size of the IN endpoint of a USB large-capacity storage device */
extern uint16_t gDiskBulkOutEpSize;  													/* The maximum packet size of the OUT endpoint of a USB large-capacity storage device */
extern uint8_t  gDiskInterfNumber;														/* The port number of the USB large-capacity storage device */
