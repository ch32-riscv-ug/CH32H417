...
/*********************************************************************
 * @fn      HOST_SS_HUB_ACCESS_SECTOR
 *
 * @brief   USBSS can scan the sectors of the USB drive by operating it through a HUB.
 *
 * @param   none.
 *
 * @return  none
 */
void HOST_SS_HUB_ACCESS_SECTOR( void )
{
    uint8_t  s, buf[ 512 ];
