...
/*
 * @Note
 * This routine demonstrates how the CH32H417 can act as a USB host to control 
 * the udisk under the HUB£¨Support for file system£©.
...
int main(void)
{
    ...
    printf("This Routine Shows CH32H417 USB Host Controls U-Disk via HUB\r\n");
