...
#define OV_RESET_SET    { GPIOB->BSHR = GPIO_Pin_1; }  //Output high
#define OV_RESET_CLR    { GPIOB->BCR = GPIO_Pin_1; }  //Output low
#define OV_PWDN_SET     { GPIOB->BSHR = GPIO_Pin_0; }  //Output high
#define OV_PWDN_CLR     { GPIOB->BCR = GPIO_Pin_0; }  //Output low

//////////////////////////////////////////////////////////////////////////////////
#define OV2640_MID				0X7FA2
#define OV2640_PID				0X2642
/*When DSP address (0xff = 0x00) is selected,DSP register address mapping table of ov2640*/
...
//When the sensor address (0xff = 0x01) is selected, the DSP register address mapping table of ov2640
