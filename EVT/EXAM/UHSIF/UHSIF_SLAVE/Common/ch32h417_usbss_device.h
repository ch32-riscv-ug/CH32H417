...
extern __attribute__ ((aligned(32))) uint8_t USBSS_EP1_Tx_Buf[ DEF_USB_EP1_SS_SIZE * DEF_ENDP1_IN_BURST_LEVEL * DEF_UHSIF_RXBUF_CNT ];
extern __attribute__ ((aligned(32))) uint8_t USBSS_EP1_Rx_Buf[ DEF_USB_EP1_SS_SIZE * DEF_ENDP1_OUT_BURST_LEVEL * DEF_UHSIF_TXBUF_CNT ];
