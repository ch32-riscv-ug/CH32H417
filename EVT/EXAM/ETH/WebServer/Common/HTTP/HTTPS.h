...
#define PAGE_WRITE_START_ADDR     ((uint32_t)0x08040000) /* Start from 256K */
#define PAGE_WRITE_END_ADDR       ((uint32_t)0x08046000) /* End at 280K */
#define FLASH_ERASE_SIZE           0X2000//8192

#define BASIC_CFG_ADDR            ((uint32_t)0x08040000)
#define PORT_CFG_ADDR             ((uint32_t)0x08042000)
#define LOGIN_CFG_ADDR            ((uint32_t)0x08044000)
