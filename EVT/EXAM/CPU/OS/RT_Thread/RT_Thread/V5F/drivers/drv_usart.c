...
//    }
    ...
    if(uart->USARTx == USART8)
    {
        ...
        GPIO_PinAFConfig(GPIOB, GPIO_PinSource3, GPIO_AF11);
...
//    ch32_uart_ops.dma_transmit= ch32dma_transmit;
    ...
    /* register UART1 device */
    rt_hw_serial_register(&serial1, "uart8",
                          RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX,
                          uart);
#endif /* RT_USING_UART8 */
