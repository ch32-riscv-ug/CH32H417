...
{                                            
    ...
    USBHSD->UEP2_TX_DMA = (uint32_t)pEndp2_Buf;
...
void UDISK_Up_CSW( void )
{
    ...
    /* Load the data into the upload buffer and start the upload */
    USBHSD->UEP2_TX_LEN = 0x0D;
    USBHSD->UEP2_TX_DMA = (uint32_t)(uint8_t *)mBOC.buf;
    USBHSD->UEP2_TX_CTRL = (USBHSD->UEP2_TX_CTRL &= ~USBHS_UEP_T_RES_MASK) | USBHS_UEP_T_RES_ACK;
...
{    
    ...
    USBHSD->UEP2_TX_LEN = UDISK_Pack_Size;
    USBHSD->UEP2_TX_DMA = (uint32_t)UDisk_Pack_Buffer;
    USBHSD->UEP2_TX_CTRL = (USBHSD->UEP2_TX_CTRL &= ~USBHS_UEP_T_RES_MASK) | USBHS_UEP_T_RES_ACK;
