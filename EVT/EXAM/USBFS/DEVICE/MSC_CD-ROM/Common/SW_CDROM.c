...
{    
    ...
    memcpy(USBFSD_UEP_BUF(DEF_UEP2),pbuf,CDROM_Pack_Size);
    USBFSD->UEP2_TX_LEN = CDROM_Pack_Size;
    USBFSD->UEP2_TX_CTRL = (USBFSD->UEP2_TX_CTRL & ~USBFS_UEP_T_RES_MASK) | USBFS_UEP_T_RES_ACK;
