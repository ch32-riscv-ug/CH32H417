...
#define DEF_USBD_UEP0_SIZE            8     /* usb hs/fs/ls device end-point 0 size */
/* HS */
...
/* LS */
#define DEF_USB_EP1_LS_SIZE           DEF_USBD_LS_PACK_SIZE
#define DEF_USB_EP2_LS_SIZE           DEF_USBD_LS_PACK_SIZE
#define DEF_USB_EP3_LS_SIZE           DEF_USBD_LS_PACK_SIZE
#define DEF_USB_EP4_LS_SIZE           DEF_USBD_LS_PACK_SIZE
#define DEF_USB_EP5_LS_SIZE           DEF_USBD_LS_PACK_SIZE
#define DEF_USB_EP6_LS_SIZE           DEF_USBD_LS_PACK_SIZE
/* ... */
