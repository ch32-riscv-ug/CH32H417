...
u8 NAND_Init(void)
{
    ...
    FMC_NAND_PCCARDTimingInitTypeDef  ComSpaceTiming;
    FMC_NAND_PCCARDTimingInitTypeDef  AttSpaceTiming;
    GPIO_InitTypeDef  GPIO_InitStructure;

    RCC_HB2PeriphClockCmd(RCC_HB2Periph_GPIOD | RCC_HB2Periph_GPIOE|RCC_HB2Periph_AFIO,ENABLE);
    ...
    FMC_NANDInitStructure.FMC_TCLRSetupTime = 0;
    FMC_NANDInitStructure.FMC_TARSetupTime = 1;
