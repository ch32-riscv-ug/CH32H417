...
#define FILTER_MODE_4    	      4       //--Filter mode 3, multiple key outputs possible--
...
extern uint16_t TKY_GetGroupCurQueueValue (uint8_t groupidx, uint8_t curQueueNum);
/*********************************************************************
 * @fn      TKY_PollForFilterMode_3
 *
 * @brief   TouchKey main loop polling mode, suitable for filter 3 filtering, 
 *			execution process blocking
 *
 * @param   none
 *
...
/*********************************************************************
 * @fn      TKY_PollForFilterMode_4
 *
 * @brief   TouchKey main loop polling mode, suitable for filter 3 filtering, 
 *			execution process no blocking
 *
 * @param   none
 *
 * @return  uint16_t - pressData, 0 is not pressed, 1 is pressed.
 */
extern uint16_t TKY_PollForFilterMode_4(void);
...
extern uint8_t TKY_SetGroupCurQueueChargeTime (uint8_t groupidx,
                                               uint8_t curQueueNum,
                                               uint16_t chargeTime,
                                               uint16_t disChargeTime);

/*********************************************************************
 * @fn      TKY_GetCurQueueChargeTime
 *
 * @brief   Gets the specified channel ChargeTime value.
 *
 * @param   curQueueNum -The current channel to be fetched.
 *
 * @return  uint16_t - Processing value for the current channel.
 */
extern uint16_t TKY_GetCurQueueChargeTime (uint8_t curQueueNum);
extern uint16_t TKY_GetGroupCurQueueChargeTime (uint8_t groupidx, uint8_t curQueueNum);

/*********************************************************************
 * @fn      TKY_GetCurQueueDisChargeTime
 *
 * @brief   Gets the specified channel DisChargeTime value.
 *
 * @param   curQueueNum -The current channel to be fetched.
 *
 * @return  uint16_t - Processing value for the current channel.
 */
extern uint16_t TKY_GetCurQueueDisChargeTime (uint8_t curQueueNum);
extern uint16_t TKY_GetGroupCurQueueDisChargeTime (uint8_t groupidx, uint8_t curQueueNum);
/*********************************************************************
...
extern uint8_t TKY_SetCurQueueThreshold (uint8_t curQueueNum,
                                         uint16_t threshold,
                                         uint16_t threshold2);
extern uint8_t TKY_SetGroupCurQueueThreshold (uint8_t groupidx,
                                              uint8_t curQueueNum,
                                              uint16_t threshold,
                                              uint16_t threshold2);

/*********************************************************************
 * @fn      TKY_GetCurQueueThreshold
 *
 * @brief   Gets the specified channel Threshold value.
 *
 * @param   curQueueNum -The current channel to be fetched.
 *
 * @return  uint16_t - Processing value for the current channel.
 */
extern uint8_t TKY_GetCurQueueThreshold (uint8_t curQueueNum,
                                         uint16_t *threshold,
                                         uint16_t *threshold2);
extern uint8_t TKY_GetGroupCurQueueThreshold (uint8_t groupidx,
                                              uint8_t curQueueNum,
                                              uint16_t *threshold,
                                              uint16_t *threshold2);
/*********************************************************************
...
extern void TKY_SetGroupCurQueueBaseLine (uint8_t groupidx, uint8_t curQueueNum, uint16_t baseLineValue);
...
extern uint16_t TKY_GetGroupCurQueueBaseLine (uint8_t groupidx, uint8_t curQueueNum);
/*********************************************************************
...
extern uint16_t TKY_GetGroupCurQueueRealVal (uint8_t groupidx, uint8_t curQueueNum);
/*********************************************************************
 ...
 * @return  none
 */
extern void TKY_ConvertIsr(void);
