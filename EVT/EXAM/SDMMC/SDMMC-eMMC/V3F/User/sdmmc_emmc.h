...
// extern SD_Error SD_ReadMultiBlocks_DualBuf( uint8_t *buf, long long addr, uint16_t blksize, uint32_t nblks );
...
// extern SD_Error SD_WriteMultiBlocks_DualBuf( uint8_t *buf, long long addr, uint16_t blksize, uint32_t nblks );
