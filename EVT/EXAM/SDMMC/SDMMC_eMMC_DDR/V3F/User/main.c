 ...
 *@Note
  ...
  This example demonstrates reading and writing all sectors of the eMMC card--KLM8G1GETF-B041 by DDR mode.
  through the SDMMC interface .
  DDR mode is affected by many factors,please modify arguments in fact:
  1、SDMMC->TUNE_CLK_CMD
  2、SDMMC->TUNE_DATO
  3、SDMMC->TUNE_DATI
  4、SDMMC->CLK_DIV
  SDMMC--PIN:
